...
export function CanvasRevealEffectDemo() {
  return (<>
    <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}
      ...
      <MidCard  title="Nisha is Munni" icon={<AceternityIcon />}>
        <CanvasRevealEffect
          animationSpeed={3}
...
const Card = ({
  ...
  return (
    (<div
      ...
      style={{ height }}
      className="border-2 overflow-clip border-white bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-purple-600 via-gray -600 to-black bg-black border-black/[0.2] group/canvas-card flex items-center justify-center rounded-xl   max-w-sm w-full mx-auto p-4 relative  ">
